...
![me](https://github.com/G3rarrd/All-Video-Downloader/blob/main/readme_media/tutorial.gif)
...
## Quick Start
> [!NOTE] 
Ensure you are in the same directory as the AllVideoDownloader class when creating and running this python file.
